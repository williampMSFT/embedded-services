...
impl DeviceDescriptor {
    pub fn new<HidDevice: hid::HidDevice>(
        ...
        let report_ids_implicit = descriptor.report_ids_implicit();
        Ok(Self {
            ...
            w_max_input_length: input_max as u16
            ...
            // As above, but for output reports.
            w_max_output_length: output_max as u16
                + HID_REPORT_HEADER_SIZE_BYTES
                + if report_ids_implicit {
                    0
                } else {
